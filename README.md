...
- 아래 링크를 모바일로 접속하여 zip파일을 다운로드 하세요.<br>
  -> https://drive.google.com/file/d/1PFyjgX6m1Ks3pR0v3BBNtoBC3E9GVDej/view?usp=share_link
- zip 파일을 압축 해제하고 어플리케이션을 설치하세요.
- 설치 시 보안 관련 안내문을 모두 허용하고 설치를 완료하세요.

---------------------------------------------------------------------------------------------------------------------------------------------------------
## Source Code Discription
![image](https://github.com/Yang-ga-hyeon/TrekBuddy/assets/113418750/da115519-a439-4b2b-8948-57648b102659)
...
- 다운받은 Zip 파일을 압축을 해제합니다.
- 안드로이드 스튜디오를 열고 압축해제한 폴더를 선택합니다.
